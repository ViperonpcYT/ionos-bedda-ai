...
5. Run diagnostic: https://bedda.ca/api/ai-diagnostic.php
   Look for:
     [5.5] GLIBC COMPATIBILITY: Status: COMPATIBLE
     [9]   ACTUAL AI TEST: AI IS FUNCTIONAL

6. Test: https://bedda.ca/api/ai-engine.php?ping=1
...
Write-Host "  4. Test: https://bedda.ca/api/ai-diagnostic.php" -ForegroundColor White
